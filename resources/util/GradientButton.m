...
- (void)useTouchUp4YNStyle
{
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:2];
    UIColor *color = HexRGB(0xEAEAEA);
    [colors addObject:(id)[color CGColor]];
    color = HexRGB(0xFFFFFF);
    [colors addObject:(id)[color CGColor]];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSMutableArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
    ...
    [layer setBorderColor:[HexRGB(0xE0E0E0)CGColor]];
    [self setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    
}

- (void)useTouchDown4YNStyle
{
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:2];
    UIColor *color = HexRGB(0x11A6D4);
    [colors addObject:(id)[color CGColor]];
    color = HexRGB(0x93E1F9);
    [colors addObject:(id)[color CGColor]];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSMutableArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
    ...
    [layer setCornerRadius:10.0];
    [layer setBorderWidth:1.0];
    [layer setBorderColor:[HexRGB(0x11A6D4)CGColor]];
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
