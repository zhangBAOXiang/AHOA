...
@interface YDContactViewController () <EGORefreshTableHeaderDelegate>{
...
@property (strong, nonatomic) YDPersonListController *personListController;

@end

@implementation YDContactViewController
